    ...
    <div id="top">
      <table class="table">
        ...
        @foreach($data as $data)
          <tr>
            <td>
              <input type="text" name="foodname[]" id="" value="{{ $data->titls }}" hidden>
              {{ $data->titls }}
            </td>
            <td>
        ...
        @foreach ($data2 as $data2)
          <tr style="position:relative; top:-160px; right:-1100px;">
            <td><a href="{{ url('/deletecart', $data2->id) }}">Delete</a></td>
          </tr>
        @endforeach
      </table>
      ...
      <div style="text-align:center; display:none" id="apear" >
        <div style="padding: 10px">
          <label for="#">Customer Name</label>
          <input type="text" name="name" id="" placeholder="Enter your fullname">
        </div>
